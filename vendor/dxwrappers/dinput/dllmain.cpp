...
// NOTE: Modified by plugin_loader; -Ry (2024/10/22)// NOTE: Modified by plugin_loader; -Ry (2024/10/22)
...
BOOL WINAPI plugin_loader_dll_main_wrapped(HMODULE hModule, DWORD dwReason, LPVOID lpReserved)
{
